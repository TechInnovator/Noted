...
// Additional processing of the image is required to avoid the rotation problem with PNG images.
// Using JPEG image representations does not have the rotation problem.
